    ...
    public class ExternalTerminologyService : ITerminologyService
    {
        ...
        public Parameters ValidateCode(Parameters parameters, string typeName, string id = null, bool useGet = false)
        {
            ...
            if (string.IsNullOrEmpty(id))
                return Endpoint.TypeOperation(RestOperation.VALIDATE_CODE, typeName, parameters) as Parameters;
            else
                return Endpoint.InstanceOperation(new Uri($"{typeName}/{id}"), RestOperation.VALIDATE_CODE, parameters) as Parameters;
        }
